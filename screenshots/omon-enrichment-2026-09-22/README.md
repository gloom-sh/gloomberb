...
Both captures were visually inspected and passed the screenshot evidence checks: usable, complete, and no semantic mismatch. Quotes are delayed observations and can change between captures. These are live-market captures, not fixture or failure-injection data.
