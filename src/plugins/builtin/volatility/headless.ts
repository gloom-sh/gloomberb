...
export function projectVolatilityHeadless(data: VolatilityData): HeadlessBundleResult {
  return { sections: [
    ...
    { title: "FRED 30D/3M history", entries: [
      { label: "As of", value: data.fred.termDate }, { label: "3M / 30D", value: data.fred.ratio },
      { label: "3M spread (points)", value: data.fred.slope },
    ] },
    ...
    { title: "Cross-asset volatility", columns: [
      ...
      { key: "percentile1y", header: "1Y percentile", align: "right", format: formattedValue },
