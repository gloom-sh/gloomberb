...
/**
 * A colour scheme: the palette half of a theme. The structural half lives in
 * `styles.ts`, and the two are combined into a resolved theme by `tokens.ts`.
 */
...
/** The scheme registry under its own name; `themes` stays for compatibility. */
export const schemes = themes;

export const DEFAULT_THEME = "amber";
export const DEFAULT_SCHEME = DEFAULT_THEME;
...
export function hasScheme(id: string): boolean {
...
export function getScheme(id: string): Theme {
  return getTheme(id);
}
