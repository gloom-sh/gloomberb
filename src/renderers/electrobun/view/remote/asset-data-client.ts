...
const assetDataPayloads: Record<string, PayloadBuilder> = {
  ...
  getPriceHistoryWithMetadata: (ticker, exchange, range, context) => ({ ticker, exchange, range, context }),
  getPriceHistoryForResolutionWithMetadata: (ticker, exchange, bufferRange, resolution, context) => ({ ticker, exchange, bufferRange, resolution, context }),
  getDetailedPriceHistoryWithMetadata: (ticker, exchange, startDate, endDate, barSize, context) => ({ ticker, exchange, startDate, endDate, barSize, context }),
